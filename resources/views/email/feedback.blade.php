...
<!-- Mirrored from themesbrand.com/velzon/html/default/apps-email-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Nov 2022 08:41:34 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Digitalogies Feedback</title>
                                                            ...
                                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                                <td class="content-block" style="font-family: 'Roboto', sans-serif; color: #878a99; line-height: 1.5; box-sizing: border-box; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 24px; text-align: center;" valign="top">
                                                                    ...
                                                                    @if ($service_name != null)
                                                                        <p> <span>{{$name}}</span> send a quote on {{$service_name}} Service</p>
                                                                    @else
                                                                        <p> <span>{{$name}}</span> send a message</p>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
